...
先安装 Node.js 20+，再前往 [GitHub Releases](https://github.com/44-99/pixel-agent-buddy/releases) 下载 Windows 安装包或便携版。应用首次启动时会询问是否安装本地 Hooks。

### 从源码运行

要求：Windows 10/11、Node.js 20+，以及 Claude Code 2.1+ 和/或支持 hooks 的 Codex CLI。
